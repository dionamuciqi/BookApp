...
public class RegisterActivity extends AppCompatActivity {
    ...
    private void validateData() {
        ...
        if (TextUtils.isEmpty(name)) {
            ...
            //confirm password edit text is empty, must enter cofirm password
            Toast.makeText(this, "Confirm Password...!", Toast.LENGTH_SHORT).show();
        } else if (!password.equals(cPassword)) {
            //password and confirm password doesn't match, don't allow to continue in that case, both password mut match
    ...
    private void updateUserInfo() {
        ...
        hashMap.put("userType", "user"); //possible values are user, admin: will make admin mually in firebase realtime database by changing this value
